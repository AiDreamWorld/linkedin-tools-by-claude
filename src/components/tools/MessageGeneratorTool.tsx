...
export default function MessageGeneratorTool() {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-12 h-12 bg-gradient-to-br from-[#ea580c] to-[#c2410c] rounded-xl flex items-center justify-center">
          <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
          </svg>
        </div>
        <div>
          <h2 className="text-xl font-bold text-gray-900">Generate Your Message</h2>
          <p className="text-gray-500 text-sm">Create personalized outreach messages</p>
        </div>
      </div>
      ...
      <div className="space-y-4 mb-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Reason / Context</label>
          <input
            type="text"
            placeholder="e.g., I read your article about AI"
            value={reason}
      ...
      <button
        ...
        disabled={generating}
        className="w-full bg-gradient-to-r from-[#ea580c] to-[#c2410c] text-white py-3 px-6 rounded-lg font-semibold hover:from-[#c2410c] hover:to-[#ea580c] transition-all disabled:opacity-50"
      >
